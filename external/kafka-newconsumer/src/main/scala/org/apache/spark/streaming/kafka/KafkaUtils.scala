...
import org.apache.spark.api.java.function.{Function => JFunction}
import org.apache.spark.streaming.api.java.JavaInputDStream.fromInputDStream
import org.apache.spark.streaming.api.java.JavaPairInputDStream.fromInputDStream
...
object KafkaUtils {
   ...
   *    "http://kafka.apache.org/090/javadoc/org/apache/kafka/clients/consumer/ConsumerConfig.html">
   *    configuration parameters</a>. Requires "metadata.broker.list" or "bootstrap.servers"
   *    to be set with Kafka broker(s) (NOT zookeeper servers), specified in
   *    host1:port1,host2:port2 form.
   *    If not starting from a checkpoint, "auto.offset.reset" may be set to "latest" or "earliest"
   *    to determine where the stream starts (defaults to "latest")
